...
namespace AspNet.Security.OAuth.Whoop;

/// <summary>
/// Defines a handler for authentication using Alipay.
/// </summary>
public partial class WhoopAuthenticationHandler : OAuthHandler<WhoopAuthenticationOptions>
{
	public WhoopAuthenticationHandler(
		[NotNull] IOptionsMonitor<WhoopAuthenticationOptions> options,
